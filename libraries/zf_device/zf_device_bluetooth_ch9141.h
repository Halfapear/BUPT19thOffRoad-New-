...
#define BLUETOOTH_CH9141_TX_PIN             (UART1_RX_P04_0       )             // 蓝牙模块对应模块的 TX 要接到单片机的 RX
#define BLUETOOTH_CH9141_RX_PIN             (UART1_TX_P04_1       )             // 蓝牙模块对应模块的 RX 要接到单片机的 TX
#define BLUETOOTH_CH9141_RTS_PIN            (P22_6		  )             // 蓝牙模块对应模块的 RTS 引脚(流控位)
