...
#define ENCODER1_TIM        (TC_CH20_ENCODER)                                  // 编码器定时器
#define ENCODER1_PLUS       (TC_CH20_ENCODER_CH1_P08_1)                        // 编码器计数端口
#define ENCODER1_DIR        (TC_CH20_ENCODER_CH2_P08_2)                        // 编码器方向采值端口
