...
//                                DIS=get_two_points_distance(gps_tau1201.latitude*1000000, gps_tau1201.longitude*1000000,flash_union_buffer[X].uint32_type,flash_union_buffer[X+1].uint32_type);
//                                X++;
...
//                                    ips_show_string(0, 16*7,"DIS:");//浮点实时点位
//                                    ips_show_float(50, 16*7, DIS, 3, 6);
...
//                        Image_get();
//
//                       ips200_full (RGB565_GREEN,0,130,239,133);
////                       ips200_full (RGB565_GREEN,195,0,198,319);
                   ...
                   while(gpio_get_level(SWITCH2))
                          {
                               ...
                               ips_show_float(0, 16*5,  gps_tau1201.latitude, 3, 6);
                               ips_show_float(0, 16*6,  gps_tau1201.longitude, 3, 6);
                               ips_show_string(0, 16*7,"satellite:");        ips_show_uint(100,  16*7, gps_tau1201.satellite_used, 5);
